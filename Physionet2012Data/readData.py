...
if __name__ == '__main__':
    ...
    dt=ReadPhysionetData("mnt/Multivariate-Time-Series-Imputation-with-Generative-Adversarial-Networks/set-a/train/", "mnt/Multivariate-Time-Series-Imputation-with-Generative-Adversarial-Networks/set-a/train//list.txt",isNormal=True,isSlicing=True)
