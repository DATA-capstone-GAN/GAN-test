# This script creates the Recurrent Neural Network that will evaluate the imputed datasets generated by the WGAN_GRUI.
# It trains on the imputed training data and uses the imputed test data to measure performance.
# It iterates through and trains on all of the imputed training datasets generated by the WGAN_GRUI and compares them to the imputed test data using AUC as a performance measure.
